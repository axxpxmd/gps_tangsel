...
<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-base font-extrabold text-gray-900">Tambah Kegiatan Baru</h2>
                <p class="text-xs text-gray-400">Tambahkan agenda kegiatan GPS TangSel</p>
            </div>
        </div>
    ...
    <form action="{{ route('console.activities.store') }}" method="POST" enctype="multipart/form-data" onsubmit="this.querySelectorAll('button[type=submit]').forEach(b => { b.disabled = true; b.classList.add('opacity-60', 'cursor-not-allowed'); b.querySelector('.btn-text').textContent = 'Menyimpan...'; })">
        @csrf
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" required
                            ...
                            placeholder="Deskripsi lengkap kegiatan...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-xs text-red-500 mt-1.5 flex items-center gap-1">
                                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>
                                {{ $message }}
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
                    ...
                    <div class="space-y-3">
                        <button type="submit"
                            ...
                            <span class="btn-text">Simpan Kegiatan</span>
                        </button>
                        <a href="{{ route('console.activities.index') }}"
