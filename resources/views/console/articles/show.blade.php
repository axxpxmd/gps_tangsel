        ...
        @if ($article->image)
            <div class="relative aspect-[21/9] bg-gray-100">
                ...
                <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-{{ $article->status === 'publish' ? 'emerald' : 'amber' }}-500 text-[11px] font-bold text-white shadow-sm">
