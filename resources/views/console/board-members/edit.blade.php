...
<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-base font-extrabold text-gray-900">Edit Pengurus</h2>
                <p class="text-xs text-gray-400 line-clamp-1">{{ $member->name }}</p>
            </div>
        </div>
        <a href="{{ route('console.board-members.show', $member) }}" class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-colors duration-200">
    ...
    <form action="{{ route('console.board-members.update', $member) }}" method="POST" enctype="multipart/form-data" onsubmit="this.querySelectorAll('button[type=submit]').forEach(b => { b.disabled = true; b.classList.add('opacity-60', 'cursor-not-allowed'); b.querySelector('.btn-text').textContent = 'Menyimpan...'; })">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-4 flex items-center justify-center min-h-[140px] bg-gray-50/50 overflow-hidden" id="gambar-preview">
                            @if ($member->gambar_url)
                                <img src="{{ $member->gambar_url }}" alt="Preview" class="max-w-[50%] h-auto object-contain rounded-xl mx-auto" id="preview-img">
                            @else
                        ...
                        @if ($member->gambar)
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-[11px] text-gray-400">File tersimpan: {{ $member->gambar }}</span>
                            </div>
                        @endif
                        @error('gambar')
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_contact" value="1" {{ old('is_contact', $member->is_contact) ? 'checked' : '' }} class="sr-only peer">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('console.board-members.show', $member) }}"
