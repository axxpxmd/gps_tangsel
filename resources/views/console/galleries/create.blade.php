            ...
            <div class="xl:col-span-2 space-y-5">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
                    <div class="flex items-center gap-2.5 mb-4 border-b border-gray-100 pb-3">
                        ...
                        <span class="text-sm font-bold text-gray-800">Gambar Galeri <span class="text-red-500">*</span></span>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-3 w-full border border-gray-200 rounded-xl p-2 bg-white hover:border-gray-300 transition-colors">
                                ...
                                <input type="file" id="gambar" name="gambar[]" accept="image/jpeg,image/png,image/webp" multiple required
                                    @change="
                                        previewUrls = [];
                                        if ($el.files) {
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="album" name="album" list="album-list" value="{{ old('album') }}" required
