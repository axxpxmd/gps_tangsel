...
<div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h2 class="text-lg font-extrabold text-gray-900">Daftar Partner</h2>
            <p class="text-xs text-gray-400 mt-0.5">{{ $partners->count() }} partner tersimpan</p>
        </div>
        <a href="{{ route('console.partners.create') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-xl hover:bg-primary-dark transition-colors duration-200 shadow-sm shadow-primary/20">
                ...
                <table class="w-full min-w-[700px]">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/80">
                            ...
                            <th class="text-left px-5 py-3.5 text-[11px] font-bold text-gray-400 uppercase tracking-wider hidden md:table-cell">Deskripsi</th>
                        ...
                        @foreach ($partners as $partner)
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                ...
                                <td class="px-5 py-4 hidden md:table-cell">
                                    <p class="text-xs text-gray-500 line-clamp-1 max-w-[200px]">{{ $partner->description ?: '-' }}</p>
                                </td>
