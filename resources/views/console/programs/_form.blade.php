            ...
            <div class="flex items-start gap-5">
                <div class="w-28 h-28 rounded-2xl bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden flex-shrink-0" id="thumbnail-preview">
                    @if (isset($program) && $program->thumbnail_url)
                        <img src="{{ $program->thumbnail_url }}" alt="Preview" class="w-full h-full object-cover" id="preview-img">
                    @else
                ...
                <div class="flex-1">
                    ...
                    @if (isset($program) && $program->thumbnail)
                        <div class="flex items-center gap-1.5 mt-2">
                            ...
                            <span class="text-[11px] text-gray-400">File tersimpan: {{ $program->thumbnail }}</span>
                        </div>
                    @endif
                </div>
            </div>
