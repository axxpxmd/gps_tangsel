...
<div class="max-w-xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-base font-extrabold text-gray-900">Tambah Tag</h2>
            <p class="text-xs text-gray-400">Buat tag artikel baru</p>
        </div>
    </div>

    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
        <form action="{{ route('console.tags.store') }}" method="POST">
            @csrf
