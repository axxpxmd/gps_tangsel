        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div class="reveal">
                ...
                <div class="flex items-center justify-center gap-3 mt-6">
                    <a href="https://www.instagram.com/gps.tangselofficial" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full bg-[#E4405F] flex items-center justify-center text-white hover:opacity-80 transition-all duration-200" aria-label="Instagram">
                    ...
                    <a href="https://www.youtube.com/@gpstangsel" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full bg-[#FF0000] flex items-center justify-center text-white hover:opacity-80 transition-all duration-200" aria-label="YouTube">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    <a href="https://www.tiktok.com/@gps_tangsel" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full bg-[#000000] flex items-center justify-center text-white hover:opacity-80 transition-all duration-200" aria-label="TikTok">
