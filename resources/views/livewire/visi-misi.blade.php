<div>
    ...
    <section class="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-dawn-night">
        ...
        <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
            <div class="flex items-center justify-center gap-3 mb-6">
                ...
                <span class="text-xs font-semibold text-gold-light uppercase tracking-wider">Visi & Misi</span>
    ...
    <section class="relative py-14 lg:py-20 bg-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal">
                <div class="relative rounded-3xl bg-gradient-to-br from-primary to-primary-dark p-10 lg:p-16 overflow-hidden">
                    ...
                    <div class="absolute top-12 right-12 w-24 h-24 bg-gold/10 rounded-full"></div>

                    <div class="relative max-w-3xl">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-14 h-14 rounded-2xl bg-gold flex items-center justify-center">
                                <svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/>
                                </svg>
                            </div>
                            <div>
                                <span class="text-xs font-bold text-gold-light uppercase tracking-wider">Visi</span>
                                <h2 class="text-2xl sm:text-3xl font-extrabold text-white">Tujuan Kami</h2>
                            </div>
                        </div>
                        <p class="text-white/80 leading-relaxed text-lg lg:text-xl font-medium">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                ...
                <div class="reveal space-y-6">
                    <div class="flex items-start gap-4 p-6 rounded-2xl bg-primary/5 border border-primary/10 hover:border-primary/20 transition-all duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Yayasan Gerakan Pejuang Subuh Tangerang Selatan</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4 p-6 rounded-2xl bg-gold/5 border border-gold/10 hover:border-gold/20 transition-all duration-300">
                        <div class="w-10 h-10 rounded-xl bg-gold flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">AHU-0017966.AH.01.04.Tahun 2024</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 p-6 rounded-2xl bg-primary/5 border border-primary/10 hover:border-primary/20 transition-all duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Notaris Alex Mondri, S.H., M.Kn. — No. 5, Tanggal 11 November 2024</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="reveal">
                    <div class="relative group cursor-pointer" onclick="document.getElementById('legalitas-modal').classList.remove('hidden'); document.getElementById('legalitas-modal').classList.add('flex'); document.body.style.overflow='hidden'">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div class="w-16 h-16 rounded-full bg-primary/90 flex items-center justify-center shadow-lg">
                                <svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="text-xs text-gray-400 text-center mt-4">Klik gambar untuk memperbesar</p>
                </div>
            </div>
        </div>
    </section>
